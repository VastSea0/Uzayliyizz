...
const Regsiter = () => {
  ...
  const validationSchema = Yup.object({
    name: Yup.string()
      .required("Gerekli")
      .min("4", "4 karakterden daha fazla olması lazım")
      .matches(/^[a-zA-Z]+$/, "sadece harflere izin var"),
    email: Yup.string().email("geçersiz e-posta").required("gerekli"),
    password: Yup.string()
      .required("gerekli")
      .min("6", "6 karakterden uzun olsun ")
      .matches(/^[a-zA-Z]+$/, "şifrede sadece belirli karakterlere izin var"),
  });
